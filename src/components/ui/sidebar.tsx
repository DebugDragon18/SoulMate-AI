...
>(
  (
    ...
    return (
      <div
        ref={ref}
        className={cn("group peer hidden md:block text-card-foreground", className)}
        data-state={state}
      ...
      >
        ...
        <div
          className={cn(
            ...
            "w-0 group-data-[collapsible=icon]:w-[var(--sidebar-width-icon)] group-data-[state=expanded]:w-[var(--sidebar-width)]",
            variant === "floating" && "w-[var(--sidebar-width)] group-data-[collapsible=icon]:w-[calc(var(--sidebar-width-icon)_+_theme(spacing.4))]"
          )}
        />
        <div
          className={cn(
            ...
            variant === "floating" && "p-2 group-data-[collapsible=icon]:w-[calc(var(--sidebar-width-icon)_+_theme(spacing.4)_+2px)]",
            variant !== "floating" && "group-data-[side=left]:border-r group-data-[side=right]:border-l"
          )}
          {...props}
        >
          <div
            data-sidebar="sidebar"
            className="flex h-full w-full flex-col bg-card group-data-[variant=floating]:rounded-xl group-data-[variant=floating]:border"
          >
            {children}
          </div>
        </div>
